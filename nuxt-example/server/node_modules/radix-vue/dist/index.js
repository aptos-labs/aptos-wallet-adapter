...
function Tl(a, t, e = {}) {
  ...
  const r = Il(() => n && "MutationObserver" in n), i = () => {
    ...
    const v = He(a), p = (Array.isArray(v) ? v : [v]).map(Be).filter(si);
    return new Set(p);
  }), d = te(
    () => u.value,
    (v) => {
...
function Qe(a, t, e = {}) {
  ...
  const r = Il(() => n && "ResizeObserver" in n), i = () => {
    s && (s.disconnect(), s = void 0);
  }, u = B(() => Array.isArray(a) ? a.map((f) => Be(f)) : [Be(a)]), d = te(
    u,
    (f) => {
      if (i(), r.value && n) {
...
const Ei = Si(), [qa, Pi] = Q("ConfigProvider"), wv = /* @__PURE__ */ x({
  inheritAttrs: !1,
...
function Ve(a, t = Ti) {
  ...
  return { createCollection: (s) => {
    ...
    return yr(() => {
      r.value = [];
    }), le(i), fl(i), te(() => s == null ? void 0 : s.value, i, { immediate: !0 }), il(e, r), r;
...
function et(a) {
  return B(() => {
    var t;
    return He(a) ? !!((t = Be(a)) != null && t.closest("form")) : !0;
  });
}
function Ot(a) {
...
const [Ll, ji] = Q("CollapsibleRoot"), Ui = /* @__PURE__ */ x({
...
const [Ya, Ji] = Q("AccordionRoot"), xv = /* @__PURE__ */ x({
...
}), [Jn, Qi] = Q("AccordionItem"), Sv = /* @__PURE__ */ x({
...
}), [at, eu] = Q("DialogRoot"), tu = /* @__PURE__ */ x({
  inheritAttrs: !1,
  __name: "DialogRoot",
  props: {
    open: { type: Boolean, default: void 0 },
...
const Gl = /* @__PURE__ */ x({
  ...
  emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "openAutoFocus", "closeAutoFocus"],
  setup(a, { emit: t }) {
    const e = a, n = t, l = at(), s = Ae(n), { forwardRef: r, currentElement: i } = R();
  ...
  emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside", "openAutoFocus", "closeAutoFocus"],
  setup(a, { emit: t }) {
    const e = a, n = t, l = at(), s = Ae(n), { forwardRef: r } = R();
    return (i, u) => (b(), S(o(De), {
  ...
  setup(a) {
    ...
    return (n, l) => {
      var s;
      return (s = o(t)) != null && s.modal.value ? (b(), S(o(De), {
        key: 0,
...
}), [Bu, Iu] = Q("AlertDialogContent"), Rv = /* @__PURE__ */ x({
...
}), [Yl, Tu] = Q("AvatarRoot"), Nv = /* @__PURE__ */ x({
  __name: "AvatarRoot",
  props: {
    asChild: { type: Boolean },
    as: { default: "span" }
...
const Fu = { style: { border: "0px", clip: "rect(0px, 0px, 0px, 0px)", "clip-path": "inset(50%)", height: "1px", margin: "-1px", overflow: "hidden", padding: "0px", position: "absolute", "white-space": "nowrap", width: "1px" } }, Nu = {
  role: "heading",
  "aria-level": "2"
}, [Xt, Lu] = Q("CalendarRoot"), zu = /* @__PURE__ */ x({
  __name: "CalendarRoot",
  props: {
    modelValue: {},
  ...
  setup(a, { emit: t }) {
    const e = a, n = t, {
      ...
      prevPage: D,
      dir: I
    } = ae(e), { primitiveElement: M, currentElement: V } = Oe(), A = Ce(I), F = ne(e, "modelValue", n, {
    ...
    te(F, (de) => {
      if (Array.isArray(de) && de.length) {
        ...
        Te && !Pe(W.value, Te) && ee(Te);
      } else !Array.isArray(de) && de && !Pe(W.value, de) && ee(de);
    });
    function ge(de) {
      if (v.value) {
        if (!F.value)
          ...
          if (F.value.findIndex((ke) => Re(ke, de)) === -1)
            F.value = [...F.value, de];
          else if (!_.value) {
            const ke = F.value.filter((Ke) => !Re(Ke, de));
            if (!ke.length) {
        ...
        !_.value && Pe(F.value, de) ? (W.value = de.copy(), F.value = void 0) : F.value = de.copy();
      }
    }
    return le(() => {
      i.value && Sl(V.value);
  ...
  setup(a) {
    const t = a, e = tt(), n = Xt(), { primitiveElement: l, currentElement: s } = Oe(), r = B(() => t.day.day.toLocaleString(n.locale.value)), i = B(() => n.formatter.custom(Ne(t.day), {
      weekday: "long",
      month: "long",
      day: "numeric",
      year: "numeric"
...
const Qu = ["value", "checked", "name", "disabled", "required"], [ed, td] = Q("CheckboxRoot"), Kv = /* @__PURE__ */ x({
  inheritAttrs: !1,
  __name: "CheckboxRoot",
  props: {
...
}), [Jl, ad] = Q("PopperRoot"), kt = /* @__PURE__ */ x({
  inheritAttrs: !1,
  __name: "PopperRoot",
  setup(a) {
    const t = T();
...
}, [ld, sd] = Q("PopperContent"), It = /* @__PURE__ */ x({
  inheritAttrs: !1,
...
}), dd = "data-radix-vue-collection-item", [no, cd] = Q("CollectionProvider");
function Ca(a = dd) {
...
const [st, fd] = Q("ComboboxRoot"), Wv = /* @__PURE__ */ x({
  __name: "ComboboxRoot",
  props: {
    modelValue: {},
    defaultValue: {},
  ...
  setup(a, { emit: t }) {
    ...
    }), te(() => [I.value.length, u.value.length], async ([L, N], [Z, Y]) => {
...
}), [es, pd] = Q("ComboboxGroup"), Yv = /* @__PURE__ */ x({
...
}), [vd, md] = Q("ComboboxContent"), hd = /* @__PURE__ */ x({
  ...
  setup(a, { emit: t }) {
    ...
    return r.contentId || (r.contentId = ye(void 0, "radix-vue-combobox-content")), (i, u) => (b(), S(o(De), {
...
}), [yd, gd] = Q("ComboboxItem"), bd = "combobox.select", em = /* @__PURE__ */ x({
  __name: "ComboboxItem",
  props: {
    value: {},
    disabled: { type: Boolean },
...
const wd = El(Cd), [Vt, ts] = Q(["MenuRoot", "MenuSub"], "MenuContext"), [_a, _d] = Q("MenuRoot"), lo = /* @__PURE__ */ x({
  __name: "MenuRoot",
  props: {
...
const [Dd, $d] = Q("RovingFocusGroup"), Ft = /* @__PURE__ */ x({
...
}), [so, Bd] = Q("MenuContent"), ro = /* @__PURE__ */ x({
  ...
  setup(a, { emit: t }) {
    ...
    function I(A) {
      if (A.defaultPrevented)
        return;
      const j = A.target.closest("[data-radix-menu-content]") === A.currentTarget, W = A.ctrlKey || A.altKey || A.metaKey, ee = A.key.length === 1, G = At(
        A,
        me(),
        $.value,
        {
      ...
      if (A.code === "Space" || (j && (A.key === "Tab" && A.preventDefault(), !W && ee && E(A.key)), A.target !== $.value) || !vu.includes(A.key))
        return;
      A.preventDefault();
      const J = h.value;
...
}), [Ad, Od] = Q("MenuRadioGroup"), vo = /* @__PURE__ */ x({
  ...
  setup(a, { emit: t }) {
    ...
    return i.contentId || (i.contentId = ye(void 0, "radix-vue-menu-sub-content")), (c, f) => (b(), S(o(De), {
...
}), [rs, Md] = Q("ContextMenuRoot"), lm = /* @__PURE__ */ x({
  inheritAttrs: !1,
...
const Ld = ["id", "value", "name", "disabled", "required"], [zd, Kd] = Q("DateFieldRoot"), Hd = /* @__PURE__ */ x({
  inheritAttrs: !1,
  ...
  emits: ["update:modelValue", "update:placeholder"],
  setup(a, { expose: t, emit: e }) {
    const n = a, l = e, { locale: s, disabled: r, readonly: i, isDateUnavailable: u, granularity: d, defaultValue: c, dir: f } = ae(n), v = Gn(n.locale), p = Ce(f), { primitiveElement: g, currentElement: m } = Oe(), _ = T(/* @__PURE__ */ new Set());
    le(() => {
    ...
    te(s, (z) => {
      ...
      !mt(z) && (!Pe(h.value, z) || h.value.compare(z) !== 0) && (h.value = z.copy());
    }), te([C, s], ([z]) => {
      mt(z) ? (Object.values(I.value).every((L) => L === null) || z === void 0) && (I.value = { ...D }) : I.value = { ...Ht({ value: z, formatter: v }) };
    });
    ...
    function J(z) {
      var L, N;
      ot(z.key) && (z.key === G.ARROW_LEFT && ((L = ee.value) == null || L.focus()), z.key === G.ARROW_RIGHT && ((N = W.value) == null || N.focus()));
    }
    function K(z) {
      F.value = z;
    }
...
const tc = /* @__PURE__ */ x({
...
}), [Co, ac] = Q("DatePickerRoot"), Am = /* @__PURE__ */ x({
  inheritAttrs: !1,
  ...
  setup(a, { emit: t }) {
    ...
    return ac({
      ...
      onPlaceholderChange(K) {
        Pe(K, ee.value) || (ee.value = K.copy());
      }
    }), (K, z) => (b(), S(o(gs), {
      open: o(G),
      "onUpdate:open": z[0] || (z[0] = (L) => Je(G) ? G.value = L : null),
      "default-open": o(m),
      modal: o(_)
    }, {
      default: y(() => [
...
}), [wo, nc] = Q("DateRangePickerRoot"), Qm = /* @__PURE__ */ x({
  inheritAttrs: !1,
  ...
  setup(a, { emit: t }) {
    ...
    return nc({
      ...
      open: o(ee),
      "onUpdate:open": K[0] || (K[0] = (z) => Je(ee) ? ee.value = z : null),
      "default-open": o(m),
      modal: o(_)
    }, {
      default: y(() => [
...
}), oc = ["id", "value", "name", "disabled", "required"], [lc, sc] = Q("DateRangeFieldRoot"), rc = /* @__PURE__ */ x({
  inheritAttrs: !1,
  ...
  setup(a, { expose: t, emit: e }) {
    var Y, re;
    const n = a, l = e, { locale: s, disabled: r, readonly: i, isDateUnavailable: u, dir: d } = ae(n), c = Gn(n.locale), { primitiveElement: f, currentElement: v } = Oe(), p = T(/* @__PURE__ */ new Set()), g = Ce(d);
    le(() => {
    ...
    })), j = B(() => ({ start: F.value.start.filter(({ part: X }) => X !== "literal"), end: F.value.end.filter(({ part: X }) => X !== "literal") })), W = T((Y = m.value.start) == null ? void 0 : Y.copy()), ee = T((re = m.value.end) == null ? void 0 : re.copy());
    te([W, ee], ([X, se]) => {
      ...
      X.start !== void 0 && (!Pe(C.value, X.start) || C.value.compare(X.start) !== 0) && (C.value = X.start.copy());
    }), te([ee, s], ([X]) => {
    ...
    function N(X) {
      var se, fe;
      ot(X.key) && (X.key === L.ARROW_LEFT && ((se = z.value) == null || se.focus()), X.key === L.ARROW_RIGHT && ((fe = K.value) == null || fe.focus()));
    }
    function Z(X) {
      G.value = X;
    }
...
}), [ds, uc] = Q("DropdownMenuRoot"), rh = /* @__PURE__ */ x({
...
}), dc = ["value", "name", "disabled", "required"], [ta, cc] = Q("EditableRoot"), xh = /* @__PURE__ */ x({
  inheritAttrs: !1,
  __name: "EditableRoot",
  props: {
    defaultValue: {},
  ...
  setup(a, { expose: t, emit: e }) {
    const n = a, l = e, {
      ...
      passive: n.modelValue === void 0
    }), { primitiveElement: I, currentElement: M } = Oe(), V = et(M), A = B(() => typeof d.value == "string" ? { edit: d.value, preview: d.value } : d.value), F = T(D.value);
    te(() => D.value, () => {
      F.value = D.value;
    }, { immediate: !0, deep: !0 });
    function j() {
    ...
    const J = Wl(() => G(), M), K = jl(() => G(), M), z = B(() => D.value === "");
    return t({
  ...
  setup(a) {
    ...
    return (r, i) => (b(), S(o(O), k(t, {
      ...
      default: y(() => [
        w(r.$slots, "default", {}, () => [
          he($e(o(e).modelValue.value || n.value), 1)
        ])
      ]),
      _: 3
...
}), [_o, fc] = Q("HoverCardRoot"), Ih = /* @__PURE__ */ x({
...
const [tn, yc] = Q("ListboxRoot"), Mh = /* @__PURE__ */ x({
  __name: "ListboxRoot",
  props: {
    modelValue: {},
    defaultValue: {},
  ...
  setup(a, { emit: t }) {
    const e = a, n = t, { multiple: l, highlightOnHover: s, orientation: r, disabled: i, selectionBehavior: u, dir: d } = ae(e), { getItems: c } = Ca(), { handleTypeaheadSearch: f } = ba(), { primitiveElement: v, currentElement: p } = Oe(), g = tt(), m = Ce(d), _ = et(p), C = T(), $ = T(!1), h = T(!0), E = ne(e, "modelValue", n, {
      defaultValue: e.defaultValue ?? (l.value ? [] : void 0),
      passive: e.modelValue === void 0,
      deep: !0
    });
...
}), gc = "listbox.select", [bc, Cc] = Q("ListboxItem"), Nh = /* @__PURE__ */ x({
  __name: "ListboxItem",
  props: {
    value: {},
    disabled: { type: Boolean },
...
}), [Ac, Oc] = Q("ListboxGroup"), Kh = /* @__PURE__ */ x({
  __name: "ListboxGroup",
  props: {
    asChild: { type: Boolean },
    as: {}
...
}), [an, kc] = Q("MenubarRoot"), Wh = /* @__PURE__ */ x({
  __name: "MenubarRoot",
  props: {
    modelValue: {},
    defaultValue: {},
...
}), [xo, Mc] = Q("MenubarMenu"), jh = /* @__PURE__ */ x({
  __name: "MenubarMenu",
  props: {
    value: {}
  },
...
}), [wt, ps] = Q(["NavigationMenuRoot", "NavigationMenuSub"], "NavigationMenuContext"), ry = /* @__PURE__ */ x({
...
const [Eo, Nc] = Q("NavigationMenuItem"), iy = /* @__PURE__ */ x({
  ...
  emits: ["escapeKeyDown", "pointerDownOutside", "focusOutside", "interactOutside"],
  setup(a, { emit: t }) {
    const e = a, n = t, l = Ae(n), { forwardRef: s } = R(), r = Ua(), i = wt(), u = Eo(), d = B(() => u.value === i.modelValue.value), c = B(() => i.viewport.value && !i.modelValue.value && i.previousValue.value ? i.previousValue.value === u.value : !1);
...
const Hc = ["value", "name", "disabled", "required"], [Po, Wc] = Q("NumberFieldRoot"), hy = /* @__PURE__ */ x({
  inheritAttrs: !1,
  ...
  setup(a, { emit: t }) {
    const e = a, n = t, { disabled: l, min: s, max: r, step: i, locale: u, formatOptions: d, id: c } = ae(e), f = ne(e, "modelValue", n, {
      defaultValue: e.defaultValue,
      passive: e.modelValue === void 0
    }), { primitiveElement: v, currentElement: p } = Oe(), g = et(p), m = T(), _ = B(
  ...
  setup(a) {
    const t = a, { primitiveElement: e, currentElement: n } = Oe(), l = Po();
    function s(u) {
...
}), [aa, jc] = Q("PaginationRoot"), Cy = /* @__PURE__ */ x({
...
const Sy = /* @__PURE__ */ x({
...
}), qc = ["id", "value", "name", "disabled", "required"], [Yc, Xc] = Q("PinInputRoot"), $y = /* @__PURE__ */ x({
  inheritAttrs: !1,
  __name: "PinInputRoot",
  props: {
    modelValue: {},
  ...
  setup(a) {
    const t = a, e = Yc(), n = B(() => Array.from(e.inputElements.value)), l = B(() => e.modelValue.value[t.index]), s = B(() => t.disabled || e.disabled.value), r = B(() => e.otp.value), i = B(() => e.type.value === "number"), u = B(() => e.mask.value), { primitiveElement: d, currentElement: c } = Oe();
    function f(D) {
      var V;
      const I = D.target;
...
}), [Lt, Zc] = Q("PopoverRoot"), gs = /* @__PURE__ */ x({
  __name: "PopoverRoot",
  props: {
    defaultOpen: { type: Boolean, default: !1 },
    open: { type: Boolean, default: void 0 },
  ...
  setup(a, { emit: t }) {
    ...
    return l.contentId || (l.contentId = ye(void 0, "radix-vue-popover-content")), (i, u) => (b(), S(o(De), {
      present: i.forceMount || o(l).open.value
    }, {
      default: y(() => [
...
}), ca = 100, [ef, tf] = Q("ProgressRoot"), Do = (a) => typeof a == "number";
function af(a, t) {
...
}), [of, lf] = Q("RadioGroupRoot"), Ry = /* @__PURE__ */ x({
...
}), [uf, df] = Q("RadioGroupItem"), Ay = /* @__PURE__ */ x({
  inheritAttrs: !1,
...
const ff = { style: { border: "0px", clip: "rect(0px, 0px, 0px, 0px)", "clip-path": "inset(50%)", height: "1px", margin: "-1px", overflow: "hidden", padding: "0px", position: "absolute", "white-space": "nowrap", width: "1px" } }, pf = {
  role: "heading",
  "aria-level": "2"
}, [na, vf] = Q("RangeCalendarRoot"), mf = /* @__PURE__ */ x({
  ...
  setup(a, { emit: t }) {
    const e = a, n = t, {
      ...
      nextPage: E,
      prevPage: P
    } = ae(e), { primitiveElement: D, currentElement: I } = Oe(), M = Ce(h), V = T(), A = T(), F = ne(e, "modelValue", n, {
      defaultValue: e.defaultValue ?? { start: void 0, end: void 0 },
      passive: e.modelValue === void 0
    }), j = Yt({
      defaultPlaceholder: e.placeholder,
    ...
    return te(F, (we) => {
      we.start && (!W.value || !Pe(W.value, we.start)) && (W.value = we.start.copy()), we.end && (!ee.value || !Pe(ee.value, we.end)) && (ee.value = we.end.copy());
    }), te(W, (we) => {
      we && !Pe(we, G.value) && J(we), n("update:startValue", we);
    }), te([W, ee], ([we, rt]) => {
      const je = F.value;
      if (!(je && je.start && je.end && we && rt && Pe(je.start, we) && Pe(je.end, rt)))
        if (we && rt) {
          if (je.start && je.end && Pe(je.start, we) && Pe(je.end, rt))
            return;
          Le(rt, we) ? F.value = {
            start: rt.copy(),
            end: we.copy()
  ...
  setup(a) {
    const t = a, e = na(), n = tt(), { primitiveElement: l, currentElement: s } = Oe(), r = B(() => e.formatter.custom(Ne(t.day), {
      weekday: "long",
      month: "long",
      day: "numeric",
      year: "numeric"
...
}), [We, Df] = Q("ScrollAreaRoot"), ky = /* @__PURE__ */ x({
...
const $s = /* @__PURE__ */ x({
...
}), [ln, Rf] = Q("ScrollAreaScrollbarVisible"), $o = /* @__PURE__ */ x({
  ...
  setup(a) {
    ...
    return le(() => s()), Qe(t.viewport, s), Qe(t.content, s), (r, i) => (b(), S(o(De), {
...
}), [sn, kf] = Q("ScrollAreaScrollbar"), Vy = /* @__PURE__ */ x({
  inheritAttrs: !1,
  ...
  setup(a) {
    ...
    return Qe(t.scrollbarX.value, s), Qe(t.scrollbarY.value, r), te(() => t.scrollbarX.value, s), te(() => t.scrollbarY.value, r), (i, u) => {
      var d;
  ...
  key: 0,
  value: ""
}, [_t, Is] = Q("SelectRoot"), [Lf, zf] = Q("SelectRoot"), Ly = /* @__PURE__ */ x({
  __name: "SelectRoot",
  props: {
    open: { type: Boolean, default: void 0 },
    defaultOpen: { type: Boolean },
...
}), [Bo, Wf] = Q("SelectItemAlignedPosition"), jf = /* @__PURE__ */ x({
  inheritAttrs: !1,
  ...
  setup(a, { emit: t }) {
    ...
    function C() {
      if (s.triggerElement.value && s.valueElement.value && c.value && v.value && (p != null && p.value) && (g != null && g.value) && (m != null && m.value)) {
        ...
        if (s.dir.value !== "rtl") {
          const Ee = I.left - P.left, ge = D.left - Ee, de = E.left - ge, Te = E.width + de, ke = Math.max(Te, P.width), Ke = window.innerWidth - Ge, St = Ut(ge, Ge, Math.max(Ge, Ke - ke));
          c.value.style.minWidth = `${Te}px`, c.value.style.left = `${St}px`;
        } else {
          const Ee = P.right - I.right, ge = window.innerWidth - D.right - Ee, de = window.innerWidth - E.right - ge, Te = E.width + de, ke = Math.max(Te, P.width), Ke = window.innerWidth - Ge, St = Ut(
            ge,
            Ge,
            Math.max(Ge, Ke - ke)
          );
        ...
        c.value.style.margin = `${Ge}px 0`, c.value.style.minHeight = `${K}px`, c.value.style.maxHeight = `${V}px`, n("placed"), requestAnimationFrame(() => u.value = !0);
      }
    }
    const $ = T("");
    le(async () => {
...
}, [xt, Gf] = Q("SelectContent"), qf = /* @__PURE__ */ x({
...
}), [Rs, Zf] = Q("SelectItem"), Uy = /* @__PURE__ */ x({
  __name: "SelectItem",
  props: {
    value: {},
    disabled: { type: Boolean },
...
}), [Jf, Qf] = Q("SelectGroup"), qy = /* @__PURE__ */ x({
  __name: "SelectGroup",
  props: {
    asChild: { type: Boolean },
    as: {}
...
}, [Ns, Ls] = Q(["SliderVertical", "SliderHorizontal"]), zs = /* @__PURE__ */ x({
  __name: "SliderImpl",
  props: {
    asChild: { type: Boolean },
    as: { default: "span" }
...
}), cp = ["value", "name", "disabled", "step"], [rn, fp] = Q("SliderRoot"), ag = /* @__PURE__ */ x({
  inheritAttrs: !1,
  __name: "SliderRoot",
  props: {
    name: {},
        ...
        default: y(() => [
          (b(), S(Ye(o(u) === "horizontal" ? up : dp), k(I.$attrs, {
            ...
            onStepKeyDown: M[6] || (M[6] = (V, A) => {
              if (!o(d)) {
                const W = o(Ms).includes(V.key) || V.shiftKey && o(Vs).includes(V.key) ? 10 : 1, ee = _.value, G = o(m)[ee], J = o(r) * W * A;
                P(G + J, ee, { commit: !0 });
              }
            })
          }), {
...
const Op = 100, ra = {
...
}, [lr, kp] = Q("PanelGroup"), sg = /* @__PURE__ */ x({
  ...
  setup(a, { emit: t }) {
    ...
    function P(K, z) {
      ...
      pe(Y != null);
      const se = G(N, K) === N.length - 1 ? Y - z : z - Y, fe = sa({
        delta: se,
        layout: L,
        panelConstraints: Z,
        pivotIndices: re,
    ...
    function D(K, z) {
      ...
      const {
        ...
        maxSize: fe = 100,
        minSize: xe = 0
      } = K.constraints, { panelSize: Ee } = J(
        N,
        K,
        L
      );
      Ee !== null && (re && se && Ee === Y ? Y !== X && P(K, X) : Ee < xe ? P(K, xe) : Ee > fe && P(K, fe));
    }
    function I(K, z) {
    ...
    function A(K) {
      ...
      if (K.constraints.collapsible) {
        ...
        if (pe(
          ...
          p.value.set(K.id, Y);
          const se = G(L, K) === L.length - 1 ? Y - Z : Z - Y, fe = sa({
            delta: se,
            layout: z,
            panelConstraints: N,
            pivotIndices: re,
          ...
          Aa(z, fe) || (C(fe), _.value.layout = fe, n("layout", fe), la(
            L,
            fe,
            v.value
          ));
      ...
      if (K.constraints.collapsible) {
        ...
        if (Y === Z) {
          const se = p.value.get(
            K.id
          ), fe = se != null && se >= re ? se : re, Ee = G(L, K) === L.length - 1 ? Y - fe : fe - Y, ge = sa({
            delta: Ee,
            layout: z,
            panelConstraints: N,
            pivotIndices: X,
          ...
          Aa(z, ge) || (C(ge), _.value.layout = ge, n("layout", ge), la(
            L,
            ge,
            v.value
          ));
    ...
    function W(K) {
      ...
      return Z ? Y === void 0 ? K.constraints.defaultSize === K.constraints.collapsedSize : Y === N : !1;
    }
    function ee(K) {
      const { layout: z, panelDataArray: L } = _.value, {
        collapsedSize: N = 0,
    ...
    function J(K, z, L) {
      const N = G(K, z), Y = N === K.length - 1 ? [N - 1, N] : [N, N + 1], re = L[N];
      return {
        ...z.constraints,
        panelSize: re,
        pivotIndices: Y
...
}, [Oo, Fp] = Q("StepperRoot"), ug = /* @__PURE__ */ x({
  __name: "StepperRoot",
  props: {
  ...
  setup(a, { emit: t }) {
    ...
    return te(d, async () => {
      ...
      default: y(() => [
        ...
        qe("div", Vp, " Step " + $e(o(d)) + " of " + $e(u.value.size), 1)
      ]),
      _: 3
    }, 8, ["as", "as-child", "data-linear", "data-orientation"]));
  }
}), [Sa, Np] = Q("StepperItem"), dg = /* @__PURE__ */ x({
  __name: "StepperItem",
  props: {
    step: {},
    disabled: { type: Boolean, default: !1 },
...
}), Lp = ["name", "disabled", "required", "value", "checked", "data-state", "data-disabled"], [zp, Kp] = Q("SwitchRoot"), hg = /* @__PURE__ */ x({
  __name: "SwitchRoot",
  props: {
    defaultChecked: { type: Boolean },
    checked: { type: Boolean, default: void 0 },
...
}), [pn, Hp] = Q("TabsRoot"), gg = /* @__PURE__ */ x({
  __name: "TabsRoot",
  props: {
    defaultValue: {},
    orientation: { default: "horizontal" },
...
}), [vn, Wp] = Q("TagsInputRoot"), xg = /* @__PURE__ */ x({
...
}), [ir, jp] = Q("TagsInputItem"), Eg = /* @__PURE__ */ x({
...
}), [mn, Up] = Q("ToastProvider"), Bg = /* @__PURE__ */ x({
  inheritAttrs: !1,
...
const Jp = /* @__PURE__ */ x({
  ...
  setup(a) {
    ...
    return Rl(() => {
      ...
      default: y(() => [
        he($e(o(t).label.value) + " ", 1),
        w(l.$slots, "default")
      ]),
      _: 3
    })) : ce("", !0);
  }
}), [Qp, ev] = Q("ToastRoot"), tv = /* @__PURE__ */ x({
  inheritAttrs: !1,
      ...
      o(r).viewport.value ? (b(), S(qt, {
        ...
        q(o(O), k({
          ...
          onPointermove: h[1] || (h[1] = (E) => {
            ...
            I ? (u.value = W, o(Oa)(o(qp), (G) => n("swipeMove", G), ee)) : o(ll)(W, o(r).swipeDirection.value, j) ? (u.value = W, o(Oa)(o(Gp), (G) => n("swipeStart", G), ee), E.target.setPointerCapture(E.pointerId)) : (Math.abs(P) > j || Math.abs(D) > j) && (i.value = null);
          }),
...
}), [ov, lv] = Q("ToggleGroupRoot"), sv = /* @__PURE__ */ x({
...
}), [cr, iv] = Q("ToolbarRoot"), Mg = /* @__PURE__ */ x({
  __name: "ToolbarRoot",
  props: {
    orientation: { default: "horizontal" },
    dir: {},
...
}), fr = "tooltip.open", [ko, dv] = Q("TooltipProvider"), zg = /* @__PURE__ */ x({
  inheritAttrs: !1,
...
}), [hn, cv] = Q("TooltipRoot"), Kg = /* @__PURE__ */ x({
  __name: "TooltipRoot",
  props: {
    defaultOpen: { type: Boolean, default: !1 },
    open: { type: Boolean, default: void 0 },
...
const [vr, pv] = Q("TreeRoot"), Gg = /* @__PURE__ */ x({
  __name: "TreeRoot",
  props: {
    modelValue: {},
    defaultValue: {},
