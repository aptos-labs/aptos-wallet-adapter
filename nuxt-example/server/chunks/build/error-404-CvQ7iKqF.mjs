...
import { a as useHead, b as useRouter, u as useNuxtApp, p as parseQuery, h as hasProtocol, r as resolveRouteObject, j as joinURL, d as useRuntimeConfig, n as navigateTo, w as withTrailingSlash, e as withoutTrailingSlash, f as nuxtLinkDefaults } from './server.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-bf15a6bc><div class="fixed left-0 right-0 spotlight z-10" data-v-bf15a6bc></div><div class="max-w-520px text-center z-20" data-v-bf15a6bc><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-bf15a6bc>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-bf15a6bc>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-bf15a6bc>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../../node_modules/.pnpm/nuxt@3.15.4_@parcel+watcher@2.5.1_@types+node@20.17.17_bufferutil@4.0.9_db0@0.2.3_eslint@8.57_7wrso3vvxc3p4dszt2llqzyb7e/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bf15a6bc"]]);

export { error404 as default };
//# sourceMappingURL=error-404-CvQ7iKqF.mjs.map
