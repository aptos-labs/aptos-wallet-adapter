...
export default function App() {
  ...
  return (
    <div>
      ...
      <Link
        href="https://github.com/aptos-labs/aptos-wallet-adapter/tree/main/apps/nextjs-standard-example"
        target="_blank"
      ...
      <Row>
        ...
        <Col>
          <DisplayRequiredValue
            name={"Address"}
            isCorrect={!!account?.address.toString()}
...
function DisplayOptionalValue(props: {
  name: string;
