...
__export(src_exports, {
  ...
  AptosWalletAdapterProviderNew: () => AptosWalletAdapterProviderNew,
  EXPLORE_ECOSYSTEM_URL: () => EXPLORE_ECOSYSTEM_URL,
  WalletContextNew: () => WalletContextNew,
  WalletItem: () => WalletItem,
  useWalletNew: () => useWalletNew
});
module.exports = __toCommonJS(src_exports);
__reExport(src_exports, require("@aptos-labs/wallet-adapter-core-new"), module.exports);

// src/WalletProviderNew.tsx
var import_wallet_adapter_core_new = require("@aptos-labs/wallet-adapter-core-new");
...
var WalletContextNew = (0, import_react2.createContext)(
  DEFAULT_CONTEXT
);
function useWalletNew() {
  const context = (0, import_react.useContext)(WalletContextNew);
  if (!context) {
...
var AptosWalletAdapterProviderNew = ({
  ...
  const [{ account, network, connected, wallet }, setState] = (0, import_react3.useState)(initialState);
  const [isLoading, setIsLoading] = (0, import_react3.useState)(true);
  const [walletCore, setWalletCore] = (0, import_react3.useState)();
  const [wallets, setWallets] = (0, import_react3.useState)([]);
  const [notDetectedWallets, setNotDetectedWallets] = (0, import_react3.useState)([]);
  (0, import_react3.useEffect)(() => {
    const walletCore2 = new import_wallet_adapter_core_new.WalletCoreNew(
      optInWallets,
      dappConfig,
      disableTelemetry
    );
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WalletContextNew.Provider, {
    value: {
      connect,
      disconnect,
...
var AboutAptosConnectContext = (0, import_react8.createContext)(null);
function useAboutAptosConnectContext(displayName) {
  const context = (0, import_react8.useContext)(AboutAptosConnectContext);
  if (!context) {
    throw new Error(
...
var import_wallet_adapter_core_new2 = require("@aptos-labs/wallet-adapter-core-new");
...
var Root3 = (0, import_react11.forwardRef)(
  ({ wallet, onConnect, className, asChild, children }, ref) => {
    ...
    const isWalletReady = wallet.readyState === import_wallet_adapter_core_new2.WalletReadyState.Installed;
    ...
    if ((0, import_wallet_adapter_core_new2.isMobile)()) {
      if (!isWalletReady && (0, import_wallet_adapter_core_new2.isRedirectable)() && !mobileSupport)
        return null;
    }
