...
__export(src_exports, {
  Eip6963Wallet: () => Eip6963Wallet,
  Eip6963WalletUrls: () => Eip6963WalletUrls,
  Eip6963Wallets: () => Eip6963Wallets2,
  fetchEthereumWallets: () => fetchEthereumWallets
});
  ...
  const features = {
    "eip6963:account": {
      account: async () => {
        ...
        return {
          address: accounts[0],
          publicKey: import_ethers.ethers.getBytes(accounts[0])
        };
      },
      version: "1.0.0"
    },
...
var Eip6963Wallet = class extends import_wallet_adapter_aggregator_core.AdapterWallet {
  ...
  async connect() {
    ...
    this.provider = new import_ethers2.ethers.BrowserProvider(
