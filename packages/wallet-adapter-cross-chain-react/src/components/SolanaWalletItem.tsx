// import { SolanaWallet } from "@aptos-labs/wallet-adapter-core";
...
// export interface SolanaWalletItemProps extends HeadlessComponentProps {
...
// const Root = forwardRef<HTMLDivElement, SolanaWalletItemProps>(
