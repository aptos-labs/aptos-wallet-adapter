// import { Eip6963Wallet } from "@aptos-labs/wallet-adapter-core";
...
// export interface EthereumWalletItemProps extends HeadlessComponentProps {
...
// const Root = forwardRef<HTMLDivElement, EthereumWalletItemProps>(
...
// function createHeadlessComponent<TElement extends keyof JSX.IntrinsicElements>(
//   displayName: string,
