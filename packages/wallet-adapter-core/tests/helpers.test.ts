...
describe("Helper Functions", () => {
  ...
  describe("generalizedErrorMessage", () => {
    ...
    it("should throw for null input (typeof null === 'object')", () => {
      // Note: This is expected behavior because typeof null === 'object' in JS
      // The 'in' operator throws when used with null
      expect(() => generalizedErrorMessage(null)).toThrow();
    });
  });
